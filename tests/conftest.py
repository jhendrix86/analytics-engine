...
SQLite database so tests exercise the real routers and real SQLAlchemy
models end to end. asyncio_mode=auto (pytest.ini) means the @pytest.mark.asyncio
markers in the older test_smoke.py are redundant but harmless.
"""
...
async def db_engine():
    ...
    from app.models import metric, dashboard, report, prediction, kpi  # noqa: F401
